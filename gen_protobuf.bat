...
If "%errorlevel%" == "0" (
.\db2go.exe proto --url %DSN_URL% --gogo-options %GOGO_OPTIONS% ^
--out %OUT_DIR% --db %DB_NAME% --table %TABLE_NAME% --suffix %SUFFIX_NAME% --package %PACK_NAME% --merge --without %WITH_OUT%
