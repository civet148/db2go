...
type InventoryOut struct {
	...
	CreatedAt  *time.Time    `json:"created_at" db:"created_at" gorm:"column:created_at;type:timestamp;autoCreateTime;index:idx_inventory_out_created_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	UpdatedAt  *time.Time    `json:"updated_at" db:"updated_at" gorm:"column:updated_at;type:timestamp;autoUpdateTime;index:idx_inventory_out_updated_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	IsDeleted  int8          `json:"is_deleted" db:"is_deleted" gorm:"column:is_deleted;type:tinyint(1);default:0;default:null;" sqlca:"nullable"`
	DeleteTime *time.Time    `json:"delete_time" db:"delete_time" gorm:"column:delete_time;type:datetime;default:null;" sqlca:"nullable"`
	ProductId  uint64        `json:"product_id" db:"product_id" gorm:"column:product_id;type:bigint unsigned;index:i_product_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:1;default:0;default:null;" sqlca:"nullable"`
	...
	UserId     uint64        `json:"user_id" db:"user_id" gorm:"column:user_id;type:bigint unsigned;index:i_user_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:2;default:0;default:null;" sqlca:"nullable"`
	...
	Quantity   sqlca.Decimal `json:"quantity" db:"quantity" gorm:"column:quantity;type:decimal(16,6);default:0.000000;default:null;" sqlca:"nullable"`
	Weight     sqlca.Decimal `json:"weight" db:"weight" gorm:"column:weight;type:decimal(16,6);default:0.000000;default:null;" sqlca:"nullable"`
	Remark     string        `json:"remark" db:"remark" gorm:"column:remark;type:varchar(512);default:null;" sqlca:"nullable"`
	CreateId   uint64        `json:"create_id" db:"create_id" gorm:"column:create_id;type:bigint unsigned;default:0;default:null;" sqlca:"nullable"`
	CreateName string        `json:"create_name" db:"create_name" gorm:"column:create_name;type:varchar(64);default:null;" sqlca:"nullable"`
	UpdateId   uint64        `json:"update_id" db:"update_id" gorm:"column:update_id;type:bigint unsigned;default:0;default:null;" sqlca:"nullable"`
