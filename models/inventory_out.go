...
type InventoryOut struct {
	...
	CreatedAt  *time.Time    `json:"created_at" gorm:"column:created_at;type:timestamp;autoCreateTime;index:idx_inventory_out_created_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	UpdatedAt  *time.Time    `json:"updated_at" gorm:"column:updated_at;type:timestamp;autoUpdateTime;index:idx_inventory_out_updated_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	IsDeleted  int8          `json:"is_deleted" gorm:"column:is_deleted;type:tinyint(1);default:0;null;" sqlca:"nullable"`
	DeleteTime *time.Time    `json:"delete_time" gorm:"column:delete_time;type:datetime;null;" sqlca:"nullable"`
	ProductId  uint64        `json:"product_id" gorm:"column:product_id;type:bigint unsigned;index:i_product_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:1;default:0;null;" sqlca:"nullable"`
	OrderNo    string        `json:"order_no" gorm:"column:order_no;type:varchar(64);uniqueIndex:UNIQ_ORDER_NO,priority:1;null;" sqlca:"nullable"`
	UserId     uint64        `json:"user_id" gorm:"column:user_id;type:bigint unsigned;index:i_user_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:2;default:0;null;" sqlca:"nullable"`
	UserName   string        `json:"user_name" gorm:"column:user_name;type:varchar(64);index:FULTXT_user_name,priority:1;null;" sqlca:"nullable"`
	Quantity   sqlca.Decimal `json:"quantity" gorm:"column:quantity;type:decimal(16,6);default:0.000000;null;" sqlca:"nullable"`
	Weight     sqlca.Decimal `json:"weight" gorm:"column:weight;type:decimal(16,6);default:0.000000;null;" sqlca:"nullable"`
	Remark     string        `json:"remark" gorm:"column:remark;type:varchar(512);null;" sqlca:"nullable"`
	CreateId   uint64        `json:"create_id" gorm:"column:create_id;type:bigint unsigned;default:0;null;" sqlca:"nullable"`
	CreateName string        `json:"create_name" gorm:"column:create_name;type:varchar(64);null;" sqlca:"nullable"`
	UpdateId   uint64        `json:"update_id" gorm:"column:update_id;type:bigint unsigned;default:0;null;" sqlca:"nullable"`
	UpdateName string        `json:"update_name" gorm:"column:update_name;type:varchar(64);null;" sqlca:"nullable"`
}
