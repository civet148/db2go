...
type InventoryOut struct {
	...
	ProductId  uint64        `json:"product_id,omitempty" db:"product_id" gorm:"column:product_id;type:bigint unsigned;default:0;index:i_product_id;uniqueIndex:UNIQ_PROD_USER;"` //产品ID
	OrderNo    string        `json:"order_no,omitempty" db:"order_no" gorm:"column:order_no;type:varchar(64);;uniqueIndex:UNIQ_ORDER_NO;"`                                        //出库单号
	UserId     uint64        `json:"user_id,omitempty" db:"user_id" gorm:"column:user_id;type:bigint unsigned;default:0;index:i_user_id;uniqueIndex:UNIQ_PROD_USER;"`             //收货人ID
