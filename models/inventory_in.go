...
type InventoryIn struct {
	...
	DeleteTime *time.Time    `json:"delete_time,omitempty" db:"delete_time" gorm:"column:delete_time;type:datetime;default:null;" sqlca:"isnull"`                              //
	ProductId  uint64        `json:"product_id,omitempty" db:"product_id" gorm:"column:product_id;type:bigint unsigned;index:idx_prod_create_id;default:null;" sqlca:"isnull"` //
	OrderNo    string        `json:"order_no,omitempty" db:"order_no" gorm:"column:order_no;type:varchar(64);uniqueIndex:UNIQ_ORDER_NO;default:null;" sqlca:"isnull"`          //
	UserId     uint64        `json:"user_id,omitempty" db:"user_id" gorm:"column:user_id;type:bigint unsigned;default:0;" sqlca:"isnull"`                                      //
	UserName   string        `json:"user_name,omitempty" db:"user_name" gorm:"column:user_name;type:varchar(64);default:null;" sqlca:"isnull"`                                 //
	...
	Remark     string        `json:"remark,omitempty" db:"remark" gorm:"column:remark;type:varchar(512);default:null;" sqlca:"isnull"`                                         //
	CreateId   uint64        `json:"create_id,omitempty" db:"create_id" gorm:"column:create_id;type:bigint unsigned;index:idx_prod_create_id;default:0;" sqlca:"isnull"`       //
