...
type User struct {
	...
	CreatedAt *time.Time    `json:"created_at" db:"created_at" gorm:"column:created_at;type:timestamp;autoCreateTime;index:idx_users_created_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	UpdatedAt *time.Time    `json:"updated_at" db:"updated_at" gorm:"column:updated_at;type:timestamp;autoUpdateTime;index:idx_users_updated_at,priority:1;default:CURRENT_TIMESTAMP;not null;" sqlca:"readonly"`
	...
	State     UserState     `json:"state" db:"state" gorm:"column:state;type:tinyint(1);default:0;default:null;" sqlca:"nullable"`
